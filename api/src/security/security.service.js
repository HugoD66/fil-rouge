...
var person_entity_1 = require("@fil-rouge/api/person/entities/person.entity");
...
var SecurityService = function () {
    ...
    var SecurityService = _classThis = /** @class */ (function () {
        function SecurityService_1(dataSource, userRepository) {
            this.dataSource = dataSource;
            this.userRepository = userRepository;
        }
        SecurityService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, firstName, lastName, existing, queryRunner, passwordHash, user, saved, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            ...
                            user = queryRunner.manager.create(person_entity_1.Person, {
                                email: email,
                                firstName: firstName,
                                lastName: lastName,
                        ...
                        case 9:
                            ...
                            throw new Error('Registration failed' +
                                (error_1 instanceof Error ? ": ".concat(error_1.message) : ''));
        ...
        SecurityService_1.prototype.login = function (loginDto) {
            return loginDto;
        };

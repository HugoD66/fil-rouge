...
var PersonDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({ example: '0000-0000-0000-0001' })];
            _firstName_decorators = [(0, swagger_1.ApiProperty)({ example: 'Pierre' })];
            _lastName_decorators = [(0, swagger_1.ApiProperty)({ example: 'Dupont' })];
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'example@email.com' })];
